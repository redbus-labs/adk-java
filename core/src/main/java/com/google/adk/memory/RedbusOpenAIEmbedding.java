 ...
 */
public class RedbusOpenAIEmbedding implements EmbeddingService {
  ...
  public RedbusOpenAIEmbedding(String username, String password) {
    this(username, password, 1);
  }

  public RedbusOpenAIEmbedding(String username, String password, int api) {
